            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{{ $errors->has('shortname') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="shortname" type="text" class="form-control" name="shortname" value="{{ old('shortname') }}" autofocus>
                    ...
                    <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="group" type="text" class="form-control" name="group" value="{{ old('group') }}" autofocus>
