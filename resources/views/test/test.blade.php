            ...
            <ul class="timeline">
                ...
                <li>
                    ...
                    <div class="timeline-body">
                        La prueba cuenta con {{$item->num}} preguntas, y tiene una duración de {{$item->minutes}} minutos, antes de finalizar la prueba asegurese de haber marcado las respuestas
                    </div>
